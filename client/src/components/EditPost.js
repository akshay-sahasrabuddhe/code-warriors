           ...
           if(flag){
            ...
            props.handleClose(false);
                        ...
                        <div className="mb-3">
                            ...
                            <input type="text" className="form-control" id="title" aria-describedby="emailHelp" defaultValue={props.n.title} ref={(node)=>{
                            title = node;
                        }} />
                        </div>
                        <div className="mb-3">
                            <label htmlFor="body" className="col-form-label">Message:</label>
                            <textarea className="form-control" id="body" defaultValue={props.n.body} ref={(node)=>{
                            body = node;
                        }} ></textarea>
                        </div>
                        <div className="mb-3">
