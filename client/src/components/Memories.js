...
const[getmemoriesdata,setgetmemoriesdata] = useState([]);
    ...
    const openComments = param => event => {
      ...
      let memoriescontainer,memcomcontainer,memoriescontainer1,memcomcontainer1,memoriescontainer2,memcomcontainer2 = null;
  ...
  useEffect(() => {
    async function getallmemories(){
      const instance = axios.create({
        ...
        console.log(seecomdata.data[0].today[0].comments);
 ...
 memcomcontainer = getmemoriesdata.today && getmemoriesdata.today.map((n) => {
    ...
    <div className="right-header-box flex-grow-1">
        ...
        <p className="card-title"><strong>{n.userThatPosted.firstName}</strong></p>
        </div>
  ...
  memoriescontainer = getmemoriesdata.today && getmemoriesdata.today.map((n) => {
      ...
      return(
          ...
          <div className="card post-card align-self-center mb-3">
                ...
                <div className="post-row flex-column">
                    ...
                    {imgstr.includes(null) ? <img className="img-fluid" src={imgstr} alt="post image" style={{display:"none"}} /> : <img className="img-fluid" src={imgstr} alt="post image"/>}
                </div>
                <hr className="m-0 mb-2"></hr>
                <div className="post-row flex-row justify-content-between me-3 ms-3">
                    ...
                    <a className="memories-comments-button" type="button" onClick={(e) => openComments(1)(e)} >
                        <span className="text-secondary me-2">{n.comments.length}</span>
...
memcomcontainer1 = getmemoriesdata.week && getmemoriesdata.week.map((n) => {
  ...
  memoriescontainer1 = getmemoriesdata.week && getmemoriesdata.week.map((n) => {
...
memcomcontainer2 = getmemoriesdata.month && getmemoriesdata.month.map((n) => {
  ...
  memoriescontainer2 = getmemoriesdata.month && getmemoriesdata.month.map((n) => {
            ...
            <div className="container">
                <div className="row">
                    <div className="col-sm-12">
                        ...
                        <div className="card-header memories-card-heading border-0"><strong>Today</strong></div>
                            {memoriescontainer}
                        </div>
                        <div className="read-post-section mb-5">
                        <div className="card-header memories-card-heading border-0"><strong>A Week Ago</strong></div>
                            {memoriescontainer1}
                        </div>
                        <div className="read-post-section mb-5">
                        <div className="card-header memories-card-heading border-0"><strong>A Month Ago</strong></div>
                            {memoriescontainer2}
                        </div>
                    </div>
                </div>
