...
return(
    <div className="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
          ...
          await instance
            .patch(`http://localhost:3000/updateprofile`, user)
...
=======
            await instance.patch(`http://localhost:3000/updateprofile`, user)
               ...
               <FloatingLabel
                ...
                {/* <FloatingLabel controlId="date" label="Date of Birth" className="mb-3" >
>>>>>>> 2ea76a7bf4efa7f21483426aee06f1f330bb34cd
          ...
          <Form.Label className="select">
            ...
            <Form.Select
              ...
              size="lg"
              className="textform"
              defaultValue={props.about.gender}
              ref={(node) => {
                gender = node;
              }}
            >
          ...
          <Form.Label className="select">
            ...
            <Form.Select
              ...
              className="textform"
              size="lg"
              defaultValue={props.about.relationshipStatus}
              ref={(node) => {
                relationStatus = node;
              }}
            >
