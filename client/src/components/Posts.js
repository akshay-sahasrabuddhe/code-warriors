           ...
           if(flag){
            ...
            props.handleClose(false);
                        ...
                        <div className="mb-3">
                            ...
                            <input type="text" className="form-control" id="title" aria-describedby="emailHelp" defaultValue={n.title} ref={(node)=>{
                            title = node;
                        }} />
                        </div>
                        <div className="mb-3">
            ...
            <div className="d-flex justify-content-between">
                ...
                <div className="d-flex justify-content-between">
                    <div className="p-2 p-lg-3 pb-0 pb-lg-0 ps-lg-0">
                        <button type="button" className="btn btn-outline-primary delete-post-btn d-flex" onClick={openeditmodal}>
